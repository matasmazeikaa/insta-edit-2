                ...
                .map((clip) => (
                    <div key={clip.id} className="bg-green-500">
                        <div
                            ...
                            className={`absolute border border-gray-500 border-opacity-50 rounded-md top-2 h-12 rounded text-white text-sm flex items-center justify-center cursor-pointer ${
                                clip.isPlaceholder 
                        ...
                        >
                            ...
                            <Image
                                ...
                                src={clip.isPlaceholder 
                                    ...
                                    : "https://www.svgrepo.com/show/535454/image.svg"
                                }
                            />
