                ...
                <div className="space-y-2">
                    ...
                    <div>
                        <textarea
                            ...
                            className="w-full p-2 bg-darkSurfacePrimary border border-white border-opacity-10 shadow-md text-white rounded focus:outline-none focus:ring-2 focus:ring-white-500 focus:border-white-500 resize-y"
                            rows={6}
                            wrap="soft"
